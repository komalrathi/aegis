...
# 6 "src/parser_frontend/parser.mly"
       (int)
# 22 "src/parser_frontend/parser.ml"
  )
    | GTE
    | GT
    | FALSE
...
# 40 "src/parser_frontend/parser.ml"
...
let _menhir_action_01 =
  fun _startpos_i_ i ->
    ...
    (
# 67 "src/parser_frontend/parser.mly"
        (Integer(_startpos, i))
...
let _menhir_action_02 =
  fun _startpos_e1_ e1 e2 ->
    let op = 
# 47 "src/parser_frontend/parser.mly"
       ( PLUS )
# 119 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 68 "src/parser_frontend/parser.mly"
...
let _menhir_action_03 =
  fun _startpos_e1_ e1 e2 ->
    let op = 
# 48 "src/parser_frontend/parser.mly"
        ( MINUS )
# 133 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 68 "src/parser_frontend/parser.mly"
                            (BinOp(_startpos, op, e1, e2))
# 139 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
# 49 "src/parser_frontend/parser.mly"
           ( MULTIPLY )
# 147 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 68 "src/parser_frontend/parser.mly"
                            (BinOp(_startpos, op, e1, e2))
# 153 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
# 50 "src/parser_frontend/parser.mly"
         ( DIVIDE )
# 161 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 68 "src/parser_frontend/parser.mly"
                            (BinOp(_startpos, op, e1, e2))
# 167 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))

let _menhir_action_06 =
  fun _startpos_e1_ e1 e2 ->
    let op = 
# 53 "src/parser_frontend/parser.mly"
     ( LT )
# 175 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 69 "src/parser_frontend/parser.mly"
                             (CompOp(_startpos, op, e1, e2))
# 181 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))

let _menhir_action_07 =
  fun _startpos_e1_ e1 e2 ->
    let op = 
# 54 "src/parser_frontend/parser.mly"
     ( GT )
# 189 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 69 "src/parser_frontend/parser.mly"
                             (CompOp(_startpos, op, e1, e2))
# 195 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
# 55 "src/parser_frontend/parser.mly"
      ( LTE )
# 203 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 69 "src/parser_frontend/parser.mly"
                             (CompOp(_startpos, op, e1, e2))
# 209 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))

let _menhir_action_09 =
  fun _startpos_e1_ e1 e2 ->
    let op = 
# 56 "src/parser_frontend/parser.mly"
      ( GTE )
# 217 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 69 "src/parser_frontend/parser.mly"
                             (CompOp(_startpos, op, e1, e2))
# 223 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
let _menhir_action_10 =
  fun _startpos__1_ ->
    ...
    (
# 70 "src/parser_frontend/parser.mly"
       (Boolean(_startpos, true))
# 232 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
let _menhir_action_11 =
  fun _startpos__1_ ->
    let _startpos = _startpos__1_ in
    (
# 71 "src/parser_frontend/parser.mly"
        (Boolean(_startpos, false))
# 241 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
# 59 "src/parser_frontend/parser.mly"
      ( AND )
# 249 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 72 "src/parser_frontend/parser.mly"
                                  (BoolCompOp(_startpos, op, e1, e2))
# 255 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
# 60 "src/parser_frontend/parser.mly"
     ( OR )
# 263 "src/parser_frontend/parser.ml"
     in
    let _startpos = _startpos_e1_ in
    (
# 72 "src/parser_frontend/parser.mly"
                                  (BoolCompOp(_startpos, op, e1, e2))
# 269 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))

let _menhir_action_14 =
  fun e ->
    (
# 64 "src/parser_frontend/parser.mly"
              (e)
# 277 "src/parser_frontend/parser.ml"
     : (Parsed_ast.expr))
...
include struct
  ...
  and _menhir_run_25 : type  ttv_stack. ((ttv_stack, _menhir_box_program) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_program) _menhir_state -> _ -> _menhir_box_program =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _startpos _v _menhir_s _tok ->
  ...
  and _menhir_run_23 : type  ttv_stack. ((ttv_stack, _menhir_box_program) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_program) _menhir_state -> _ -> _menhir_box_program =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | OR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos) in
  ...
  and _menhir_run_21 : type  ttv_stack. ((ttv_stack, _menhir_box_program) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_program) _menhir_state -> _ -> _menhir_box_program =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _startpos _v _menhir_s _tok ->
      ...
      | AND ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos) in
          _menhir_run_14 _menhir_stack _menhir_lexbuf _menhir_lexer
      | DIVIDE | EOF | GT | GTE | LT | LTE | MINUS | MULTIPLY | PLUS ->
          let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_) = _menhir_stack in
          let e2 = _v in
  ...
  and _menhir_run_17 : type  ttv_stack. ((ttv_stack, _menhir_box_program) _menhir_cell1_expr as 'stack) -> _ -> _ -> _ -> _ -> ('stack, _menhir_box_program) _menhir_state -> _ -> _menhir_box_program =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _startpos _v _menhir_s _tok ->
      match (_tok : MenhirBasics.token) with
      | OR ->
          let _menhir_stack = MenhirCell1_expr (_menhir_stack, _menhir_s, _v, _startpos) in
  ...
  and _menhir_run_09 : type  ttv_stack. (ttv_stack, _menhir_box_program) _menhir_cell1_expr -> _ -> _ -> _ -> _ -> _menhir_box_program =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      let MenhirCell1_expr (_menhir_stack, _menhir_s, e1, _startpos_e1_) = _menhir_stack in
      let e2 = _v in
      let _v = _menhir_action_13 _startpos_e1_ e1 e2 in
      _menhir_goto_expr _menhir_stack _menhir_lexbuf _menhir_lexer _startpos_e1_ _v _menhir_s _tok
